...
public class ActionPathFactory {
	...
	public class ActionPathBuilder {
		 ...
		 * {@link ActionContext} is scanned for the last occurence of the
		 * supplied controller class, and the elements of the invoked path up to
		 * this point are prepended to the {@link ActionPath} .
		 */
