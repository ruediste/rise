...
public class HttpRequestParsingModuleTest {

	HttpRequestParsingModule mappingModule;
	HttpRequestParsingService mappingService;
	BaseModule baseModule;
	HttpRequestParsingRule rule;
	ActionPath<ParameterValueProvider> providerPath;
	ActionPath<Object> objectPath;

	@Before
	public void setup() {
		mappingModule = new HttpRequestParsingModule();
		mappingService = new HttpRequestParsingService();
		baseModule = mock(BaseModule.class);
		rule = Mockito.mock(HttpRequestParsingRule.class);
