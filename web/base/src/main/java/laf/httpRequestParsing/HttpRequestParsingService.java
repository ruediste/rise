...
@Singleton
public class HttpRequestParsingService {
	...
	@Inject
	@ConfigValue("laf.httpRequestParsing.defaultRule.DefaultHttpRequestParsingRuleFactory")
	Collection<HttpRequestParsingRuleFactory> mappingRuleFactories;
	...
	public ActionPath<ParameterValueProvider> parse(HttpRequest request) {
		...
		for (HttpRequestParsingRule rule : mappingRules) {
