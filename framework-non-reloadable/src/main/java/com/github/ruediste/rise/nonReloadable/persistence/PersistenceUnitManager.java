 ...
 * One instance is created per persistence unit. The methods of this class are
 * thread safe.
 * 
...
public interface PersistenceUnitManager {
     ...
     */
    void initialize(Class<? extends Annotation> qualifier, DataSourceManager dataSourceManager);
