...
import com.github.ruediste.rise.nonReloadable.lambda.expression.CapturedArgumentExpression;
...
public final class LambdaExpression<F> {
    ...
    public Object[] getCapturedArgumentValues() {
        return capturedArgumentValues;
    }

    /**
     * Create a new lambda expression, taking the same parameters and using the
     * same captured arguments, but with a new body
     */
