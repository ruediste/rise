...
final class Functions {
     ...
     * @return the value of {@code left.apply(T) < right.apply(U)}
     */
    public static <T, U, Key extends Number> BiPredicate<T, U> lessThan(Function<T, Key> left, Function<U, Key> right) {
     ...
     * @return the value of {@code left.apply(T) <= right.apply(U)}
     */
    public static <T, U, Key extends Number> BiPredicate<T, U> lessThanOrEqual(Function<T, Key> left,
     ...
     * @return the value of {@code left.apply(T) >= right.apply(U)}
     */
    public static <T, U, Key extends Number> BiPredicate<T, U> greaterThanOrEqual(Function<T, Key> left,
            Function<U, Key> right) {
        return (T t, U u) -> Objects.compare(left.apply(t), right.apply(u),
                (Key key1, Key key2) -> BinaryOperator.Subtract.eval(key1, key2).intValue()) >= 0;
    }
     ...
     * @return the value of {@code left.apply(T) > right.apply(U)}
     */
    public static <T, U, Key extends Number> BiPredicate<T, U> greaterThan(Function<T, Key> left,
            Function<U, Key> right) {
        return (T t, U u) -> Objects.compare(left.apply(t), right.apply(u),
                (Key key1, Key key2) -> BinaryOperator.Subtract.eval(key1, key2).intValue()) > 0;
    }
    ...
    public static <T, Result> Function<T, Result> property(Class<? super T> outerType, String propertyName)
            throws NoSuchMethodException {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T, Result> Function<T, Result> field(Class<? super T> outerType, // Class<?
                                                                                    // super
                                                                                    // Result>
                                                                                    // resultType,
     ...
     */
    public static <Result, T> Predicate<T> instanceOf(final Function<? super T, ? extends Result> operand,
            final Class<?> type) {
     ...
     *         {@code predicate.apply(T) ? ifTrue.apply(T) : ifFalse.apply(T)}.
     */
    public static <Result, T> Function<T, Result> iif(final Function<? super T, Boolean> predicate,
            final Function<? super T, ? extends Result> ifTrue, final Function<? super T, ? extends Result> ifFalse) {
