...
import com.github.ruediste.rise.nonReloadable.lambda.expression.ExpressionStack.BranchExpression;
...
final class ExpressionMethodVisitor extends MethodVisitor {
    ...
    /**
     * 
     * @param initialLocalVariableTypes
     *            types of the values of the local variables initialized by an
     *            optional this reference and the parameters of the method
     */
    ...
    public void visitFieldInsn(int opcode, String owner, String name, String desc) {
        ...
        case Opcodes.GETFIELD:
            try {
                e = Expression.get(_classVisitor.ownerType, _classVisitor.getClass(Type.getObjectType(owner)),
                        _exprStack.pop(), name);
