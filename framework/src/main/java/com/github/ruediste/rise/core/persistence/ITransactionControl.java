...
public interface ITransactionControl {
    ...
    /**
     * By default, the current entity managers will join any freshly started
     * transaction. Invoke this method to disable that behavior.
     */
    ITransactionControl noAutoJoin();
