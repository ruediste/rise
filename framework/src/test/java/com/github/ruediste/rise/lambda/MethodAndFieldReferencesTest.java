...
import com.github.ruediste.rise.lambda.LambdaExpressionTest.SerializableFunction;
...
public class MethodAndFieldReferencesTest {
    ...
    public void staticMethod() {
        ...
        assertEquals("()->{com.github.ruediste.rise.lambda.MethodAndFieldReferencesTest.methodNoArgs()}",
                exp.toString());
    }
    ...
    public void staticMethodWithArgs() {
        ...
        LambdaExpression<?> exp = LambdaExpression.parse(lambda);
        assertEquals(
                "(java.lang.Object P0)->{com.github.ruediste.rise.lambda.MethodAndFieldReferencesTest.methodWithArgs(P0)}",
                exp.toString());
    }
    ...
    public void testMethodRef() throws Throwable {
        ...
        assertEquals("public int com.github.ruediste.rise.lambda.Customer.getData()", f.getMember());
