...
public class LambdaExpressionTest {
    ...
    public interface SerializablePredicate<T> extends Predicate<T>, CapturingLambda {

    }

    public interface SerializableFunction<T, R> extends Function<T, R>, CapturingLambda {
    }
    ...
    public void testParseNew() throws Throwable {
        ...
        class1.getName();
        Predicate<java.util.Date> pp = ensureCaptured(d -> d.after(new java.sql.Time(System.currentTimeMillis())));
        ...
        pp = ensureCaptured(d -> d.compareTo(anotherDate) < 10);
    ...
    public void testParseP() throws Throwable {
        Predicate<Float> pp = ensureCaptured(t -> t > 6 ? t < 12 : t > 2);
    ...
    public void testParseP1() throws Throwable {
        Predicate<String> pp = ensureCaptured(t -> t.equals("abc"));
    ...
    public void testParseP2() throws Throwable {
        ...
        Predicate<Integer> pp = ensureCaptured(t -> (ar.length << t) == (1 << 5) && ar[0] instanceof Number);
    ...
    public void testParseThis() throws Throwable {
        ...
        Predicate<Integer> pp = ensureCaptured(t -> this != null);
    ...
    public void testParseP3() throws Throwable {
        ...
        Predicate<Integer> pp = ensureCaptured(t -> ar[0] instanceof Float || (ar.length << t) == (1 << 5));
    ...
    public void testParseField() throws Throwable {
        Predicate<Object[]> pp = ensureCaptured(t -> t.length == 3);
    ...
    public void testParse0() throws Throwable {
        Supplier<Float> pp = ensureCaptured(() -> 23f);
    ...
    public void testParseIllegal() throws Throwable {
        ...
        try {
            ...
            Supplier<Float> pp = ensureCaptured(() -> {
                x[0] = null;
                return 23f;
            });
            LambdaExpression<Supplier<Float>> parsed = LambdaExpression.parse(pp);
    ...
    public void testParse2() throws Throwable {
        BiFunction<Float, Float, Boolean> pp = ensureCaptured((Float t, Float r) -> t > 6 ? r < 12 : t > 2);
    ...
    public void testParse4() throws Throwable {
        Predicate<Integer> pp = ensureCaptured(r -> (r < 6 ? r > 1 : r < 4) || (r instanceof Number));
    ...
    public void testParse5() throws Throwable {
        Predicate<Integer> pp = ensureCaptured(
    ...
    public void testParse7() throws Throwable {
        Predicate<Integer> pp = ensureCaptured(r -> (r < 6 && r > 25) || r < 23);
    ...
    public void testParse10() throws Throwable {
        Function<Integer, Integer> pp = ensureCaptured(r -> ~r);
    ...
    public void testParse11() throws Throwable {
        Function<Integer, Byte> pp = ensureCaptured(r -> (byte) (int) r);
    ...
    public void canToStringACompoundExpression() throws Exception {
        SerializableFunction<String, String> e = ensureCaptured(s -> s.substring(0, 1).toUpperCase());
    ...
    public void canParseAnExpressionWhereCharIsPromotedToIntAsAMethodParameter() throws Exception {
        SerializableFunction<String, Integer> e = ensureCaptured(s -> Math.abs(s.charAt(0)));
    ...
    public void canParseAnExpressionWhereCharIsPromotedToLongAsAMethodParameter() throws Exception {
        SerializableFunction<String, Long> e = ensureCaptured(s -> Math.abs((long) s.charAt(0)));
    ...
    public void canParseAnExpressionWhereCharIsPromotedToFloatAsAMethodParameter() throws Exception {
        SerializableFunction<String, Float> e = ensureCaptured(s -> Math.abs((float) s.charAt(0)));
    ...
    public void canParseAnExpressionWhereCharIsPromotedToIntAsAnOperand() throws Exception {
        SerializableFunction<String, Integer> e = ensureCaptured(s -> s.charAt(0) + 1);
        LambdaExpression<Function<String, Integer>> parsed = LambdaExpression.parse(e);
    ...
    public void testExpression1() {
        Predicate<Person> p = ensureCaptured(t -> t.getName() == "Maria Bonita");
    ...
    protected void testExpression(@Capture SerializablePredicate<Person> p, String name) {
        final LambdaExpression<Predicate<Person>> ex = LambdaExpression.parse(p);
        assertNotNull(ex);
