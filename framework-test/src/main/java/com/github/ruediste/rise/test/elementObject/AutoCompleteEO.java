...
public class AutoCompleteEO extends PageObject {
    ...
    public AutoCompleteEO setText(String text) {
        actions.click(rootElement()).sendKeys(Keys.END).keyDown(Keys.SHIFT).sendKeys(Keys.HOME).keyUp(Keys.SHIFT)
    ...
    public AutoCompleteEO choose(String optionTestName) {
        ...
        driver.findElement(byDataTestName("rise_autocomplete_" + testName)).findElement(byDataTestName(optionTestName))
                .click();
        return this;
    }
