...
import laf.skeleton.componentTemplates.CPageHtmlTemplate;

@ApplicationScoped
public class ApplicationConfiguration implements ConfigurationDefiner {
	...
	/**
	 * Used to register additional configurations
	 */
